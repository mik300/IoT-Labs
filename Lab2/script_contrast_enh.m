...
Average_distortion_DVS_ori = sum(General_distortion_DVS_ori_contrast) ./ number_images;
Average_average_power_saving_DVS_ori = sum(General_average_power_saving_DVS_ori_contrast) ./ number_images;

Average_distortion_modDVS_ori = sum(General_distortion_modDVS_ori_contrast) ./ number_images;
Average_average_power_saving_modDVS_ori = sum(General_average_power_saving_modDVS_ori_contrast) ./ number_images;
